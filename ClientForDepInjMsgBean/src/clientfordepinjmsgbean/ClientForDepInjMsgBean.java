...
package clientfordepinjmsgbean;
...
/**
 *
 * @author tcheutchoua at May 23, 2016
 */
public class ClientForDepInjMsgBean {
    ...
    public static void main(String[] args) {
       ClientForDepInjMsgBean ejbTester = new ClientForDepInjMsgBean();
